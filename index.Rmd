...
.font120[
  - Donc, on modélise seulement avec l'espace et le temps
]
]
...
.font120[
- Application: **Prédictions** dans le **temps**
]
...
- Pour chaque année:
  ...
  - Calcul les taux de croissance de chaque espèce séparemment
  
  - Moyenne des taux de croissance de chaque espèce
  
  - Multiplie cette moyenne à la valeur de l'indice de l'année précédente

  - Première année: indice de 1
]
...
# Utilité de l'Indice Planète Vivante
<hr width="100%" align="left" size="1" color="orange"></hr>

<br>

.font120[
- Indicateur très utilisé par la Convention sur la Diversité Biologique
]

.font120[
- Beaucoup de travail sur son développement
]
