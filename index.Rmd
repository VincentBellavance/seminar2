...
- .font120[Orientation du gouvernement sur la protection de la biodiversité]
...
>.font120[
  .center[**Comparer les changements d'aires de distribution de divers groupes fonctionnels d'oiseaux**]
]
...
- **Description** de la distribution des espèces

- Utilise **seulement l'espace** comme covariables
...
.pull-right[
  ![:scale 80%;](images/method/spolypts.png)
]
...
.font120[
- **Prédictions** de l'indicateur dans le temps
